...
def get_plaid_client() -> plaid_api.PlaidApi:
    """
        The get_plaid_client function retrieves Plaid API credentials securely from AWS Secrets 
        Manager (using a secret ARN from the environment variable) and initializes a Plaid client. 
        This client is then used to interact with the Plaid API.
    """
    try:
